...
public class CorsoCucina {
    ...
    // Lista bidirezionale di iscrizioni
    ...
    public void setIdCorso(int idCorso) {
        if (idCorso <= 0) throw new IllegalArgumentException("ID corso deve essere maggiore di zero");
    ...
    public void setFrequenzaCorso(Frequenza frequenzaCorso) {
        if (frequenzaCorso == null) throw new IllegalArgumentException("Frequenza corso non può essere null");
    ...
    public void setNumeroPosti(int numeroPosti) {
        if (numeroPosti <= 0) throw new IllegalArgumentException("Il numero di posti deve essere maggiore di zero");
    ...
    public void setDataInizioCorso(LocalDateTime dataInizioCorso) {
        if (dataInizioCorso == null) throw new IllegalArgumentException("Data inizio corso non può essere null");
    ...
    public void setDataFineCorso(LocalDateTime dataFineCorso) {
        if (dataFineCorso == null) throw new IllegalArgumentException("Data fine corso non può essere null");
    ...
    // Metodi bidirezionali iscrizioni
    public void aggiungiIscrizione(Iscrizione i) {
        if (!iscrizioni.contains(i)) iscrizioni.add(i);
    }
    ...
    // Metodi toString "a pezzi"
    public String toStringIdCorso() { return "ID Corso: " + idCorso; }
    public String toStringNomeCorso() { return "Nome Corso: " + nomeCorso; }
    public String toStringPrezzo() { return "Prezzo: " + prezzo; }
    public String toStringCategoria() { return "Categoria: " + categoria; }
    public String toStringFrequenza() { return "Frequenza: " + frequenzaCorso; }
    public String toStringNumeroPosti() { return "Numero Posti: " + numeroPosti; }
    public String toStringNumeroSessioni() { return "Numero Sessioni: " + numeroSessioni; }
    public String toStringDataInizio() { return "Data Inizio Corso: " + dataInizioCorso; }
    public String toStringDataFine() { return "Data Fine Corso: " + dataFineCorso; }
