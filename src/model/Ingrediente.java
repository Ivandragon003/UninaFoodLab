...
public class Ingrediente {
	...
	public boolean equals(Object o) {
		...
		if (this.idIngrediente > 0 && that.idIngrediente > 0) {
			return this.idIngrediente == that.idIngrediente;
		}
		
		return this.nome.equalsIgnoreCase(that.nome) && this.tipo.equalsIgnoreCase(that.tipo);
	}
