...
public class VisualizzaCorsiController {
    ...
    public VisualizzaCorsiController(CorsoCucinaDAO corsoDAO, 
                                     TieneDAO tieneDAO,
                                     OnlineDAO onlineDAO, 
    ...
    public List<CorsoCucina> cercaPerNomeOCategoria(String filtro) 
        ...
        try {
            CorsoCucina corso = corsoDAO.findById(idCorso)
                    .orElseThrow(() -> new DataAccessException(
                        "Corso non trovato nel sistema (ID: " + idCorso + ")"));
    ...
    public List<Sessione> getSessioniPerCorsoInPeriodo(int idCorso, 
                                                   LocalDate inizio, 
                                                   LocalDate fine)
        throws DataAccessException {
    try {
