...
public class ChefController {
	...
	public model.Chef login(String username, String password) throws ValidationException, DataAccessException {
	...
	public List<Chef> filterChefs(List<Chef> chefs, String query, String filtroDisp) {
		...
		return chefs.stream()
				.filter(c -> (search.isEmpty() || c.getNome().toLowerCase().contains(search)
